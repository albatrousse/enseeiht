...
module EvalPrintExemple =  Exemples (Print)
let%test _ = (EvalPrintExemple.exempleDef = "let x = (1 + 2) in (x * 3)")
let%test _ = (EvalPrintExemple.exemple1 = "(1 + (2 * 3))")
let%test _ = (EvalPrintExemple.exemple2 = "((5 + 2) * (2 * 3))")
