...
(******************************************************************************)
let appartient mot (Trie (arb, fd, _)) = appartient_arbre (fd mot) arb
...
(******************************************************************************)
let retrait mot (Trie(arb, fd, fr)) = Trie(normalisation_arbre(retrait_arbre (fd mot) arb), fd, fr)
...
(******************************************************************************)
let trie_dico (Trie(arb, _, fr)) = List.map fr (parcours_arbre arb) 
